  ...
  return (
    ...
    >
      ...
      <div
        ...
        } max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen max-sm:h-full max-sm:flex-col max-sm:bg-primary max-sm:text-white max:sm:pt-20 flex sm:items-center gap-5 transition-all max-sm:pt-16`}
      >
        <img
